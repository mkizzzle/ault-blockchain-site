...
export const Route = createFileRoute("/legal/terms")({
  ...
  head: () => ({
    meta: [
      { title: "Terms & Conditions — Ault Blockchain" },
      { name: "description", content: "Ault Blockchain Terms & Conditions. Coming soon — under final review." },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-3xl px-6 py-24 md:py-32">
        <h1 className="text-4xl md:text-5xl font-semibold tracking-tight">Terms &amp; Conditions</h1>
