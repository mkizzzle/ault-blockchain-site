...
export const Route = createFileRoute("/legal/constitution")({
  component: ConstitutionPage,
  head: () => ({
    meta: [
      { title: "Constitution — Ault Blockchain" },
      { name: "description", content: "The Ault Blockchain Constitution. Coming soon — under final review." },
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="mx-auto max-w-3xl px-6 py-24 md:py-32">
        <h1 className="text-4xl md:text-5xl font-semibold tracking-tight">Constitution</h1>
        <p className="mt-6 text-lg text-text-secondary">
          Coming soon — under final review.
        </p>
