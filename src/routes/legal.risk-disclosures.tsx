...
export const Route = createFileRoute("/legal/risk-disclosures")({
  component: RiskDisclosuresPage,
  head: () => ({
    meta: [
      { title: "Risk Disclosures — Ault Blockchain" },
      { name: "description", content: "Ault Blockchain Risk Disclosures. Coming soon — under final review with counsel." },
      { name: "robots", content: "noindex" },
    ],
  }),
});

function RiskDisclosuresPage() {
  return (
    <div className="min-h-screen bg-background text-foreground">
      <StatusBar />
      <Nav />
      <section className="mx-auto max-w-3xl px-6 py-24 md:py-32">
        <h1 className="text-4xl md:text-5xl font-semibold tracking-tight">Risk Disclosures</h1>
        <p className="mt-6 text-lg text-text-secondary">
          Risk Disclosures coming soon — under final review with counsel.
        </p>
